...
package site.k8scloud.student.controller;
 ...
 * curl -X GET http://localhost:8080/student/Joe
 *
 * Change greeting
...
public class StudentResource {
     ...
     */
    @Inject
    public StudentResource(StudentProvider greetingConfig) {
        this.studentProvider = greetingConfig;
    }
    ...
    public Response updateGreeting(JsonObject jsonObject) {
        ...
        studentProvider.setMessage(newGreeting);
        return Response.status(Response.Status.NO_CONTENT).build();
    }

    private JsonObject createResponse(String who) {
        String msg = String.format("%s %s!", studentProvider.getMessage(), who);
