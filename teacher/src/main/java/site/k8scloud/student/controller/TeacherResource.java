 ...
 * curl -X GET http://localhost:8080/teacher/Joe
 *
 * Change greeting
...
public class TeacherResource {
     ...
     */
    @Inject
    public TeacherResource(TeacherProvider greetingConfig) {
        this.teacherProvider = greetingConfig;
    }
    ...
    public Response updateGreeting(JsonObject jsonObject) {
        ...
        teacherProvider.setMessage(newGreeting);
        return Response.status(Response.Status.NO_CONTENT).build();
    }

    private JsonObject createResponse(String who) {
        String msg = String.format("%s %s!", teacherProvider.getMessage(), who);
